...
invalid_zang = 1018, '藏编码格式有误'
invalid_jing = 1019, '经编码格式有误'
invalid_page_code = 1020, '页编码格式有误'
not_digit = 1021, '%s不是数字'
...
juan_not_found = 3002, '没有找到属于第几卷'
juan_file_not_found = 3003, '没有找到卷信息文件'
xml_file_not_found = 3003, '没有找到xml文件'
mulu_file_not_found = 3005, '没有找到目录信息文件'
no_result = 3006, '查无结果'
